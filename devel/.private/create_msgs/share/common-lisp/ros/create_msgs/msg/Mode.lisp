...
(cl:defmethod cl:initialize-instance :after ((m <Mode>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mode)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_msgs-msg:<Mode> is deprecated: use create_msgs-msg:Mode instead.")))
...
(cl:defmethod mode-val ((m <Mode>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:mode-val is deprecated.  Use create_msgs-msg:mode instead.")
  (mode m))
