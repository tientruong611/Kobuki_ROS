...
(cl:defmethod cl:initialize-instance :after ((m <ChargingState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ChargingState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_msgs-msg:<ChargingState> is deprecated: use create_msgs-msg:ChargingState instead.")))
...
(cl:defmethod state-val ((m <ChargingState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:state-val is deprecated.  Use create_msgs-msg:state instead.")
  (state m))
