...
(cl:defmethod cl:initialize-instance :after ((m <DefineSong>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DefineSong)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_msgs-msg:<DefineSong> is deprecated: use create_msgs-msg:DefineSong instead.")))

(cl:ensure-generic-function 'song-val :lambda-list '(m))
(cl:defmethod song-val ((m <DefineSong>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:song-val is deprecated.  Use create_msgs-msg:song instead.")
  (song m))

(cl:ensure-generic-function 'length-val :lambda-list '(m))
(cl:defmethod length-val ((m <DefineSong>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:length-val is deprecated.  Use create_msgs-msg:length instead.")
  (length m))

(cl:ensure-generic-function 'notes-val :lambda-list '(m))
(cl:defmethod notes-val ((m <DefineSong>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:notes-val is deprecated.  Use create_msgs-msg:notes instead.")
  (notes m))

(cl:ensure-generic-function 'durations-val :lambda-list '(m))
(cl:defmethod durations-val ((m <DefineSong>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader create_msgs-msg:durations-val is deprecated.  Use create_msgs-msg:durations instead.")
  (durations m))
