...
(cl:defmethod cl:initialize-instance :after ((m <PlaySong>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PlaySong)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name create_msgs-msg:<PlaySong> is deprecated: use create_msgs-msg:PlaySong instead.")))
